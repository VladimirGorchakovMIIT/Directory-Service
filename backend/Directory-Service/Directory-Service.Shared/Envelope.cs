...
public record Envelope
{
    ...
    public static Envelope Error(Errors errorsList) => new Envelope(null, errorsList);
}
...
public record Envelope<T>
{
    ...
    public static Envelope<T> Error(Errors errorsList) => new Envelope<T>(default, errorsList);
}